...
public:
    ...
    // constexpr element_t(const element_t& other)
    ...
    // constexpr element_t& operator=(U&& other) {
    //     contained = other;
    //     return *this;
    // }
...
struct vector {
    ...
    //     // }
    //     *insert_pos = value;
    //     // std::ranges::move(&value, &value + 1, insert_pos);
    //     count++;
    //     return insert_pos;
    // }
    ...
    constexpr auto insert(const_iterator pos, T&& value) -> iterator {
        ...
        // *insert_pos = element_t<T>{value};
        // std::construct_at(insert_pos, std::move(value));
        // count++;
        return insert_pos;
    }
